...
var ProductRepository = (function () {
    ...
    ProductRepository.prototype.saveProduct = function (product) {
        ...
        if (product.id == null || product.id == 0) {
            this.dataSource.saveProduct(product).subscribe(function (p) {
                console.log('prod.rep.saved-Prod.p', p);
            ...
            this.dataSource.updateProduct(product)
                ...
                console.log('prod.rep.updated-Product.p', p);
    ...
    ProductRepository.prototype.deleteProduct = function (id) {
        var _this = this;
        this.dataSource.deleteProduct(id).subscribe(function (id) {
            console.log('prod.rep.deleted-Product-ID.p', id);
